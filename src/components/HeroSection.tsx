...
export function HeroSection() {
  return (
    <section className="flex flex-col items-center justify-center px-4 pt-12 pb-8 text-center">
      ...
      <p className="mb-8 max-w-xl text-gray-400">Получи уникальные возможности, крутые префиксы и закрытый доступ к эксклюзивным командам и предметам.</p>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        ...
        <Button variant="outline" className="rounded-full border-gray-700 bg-transparent text-white hover:bg-gray-800">
          <Play className="mr-2 h-4 w-4 fill-violet-500 text-violet-500" /> Обзор сервера
        </Button>
      </div>
    </section>
  )
